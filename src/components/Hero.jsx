    ...
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl">
        ...
        <div ref={btnRef} className="mt-12 flex flex-col md:flex-row gap-6 justify-center items-center">
          <button className="group relative px-10 py-4 bg-red-700 text-white text-[11px] uppercase tracking-[0.3em] font-bold overflow-hidden transition-all hover:bg-red-600 w-full md:w-auto">
          ...
          <button className="px-10 py-4 border border-white/20 text-white text-[11px] uppercase tracking-[0.3em] font-bold hover:bg-white hover:text-black transition-all duration-500 w-full md:w-auto">
            Explore Lore
          </button>
        </div>
      </div>
